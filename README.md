...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-leaflegend-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-leaflegend-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-leaflegend
# for installing globally
pixi global install r-leaflegend
```
...
It is possible to list all of the versions of `r-leaflegend` available on your platform:
...
```
pixi search r-leaflegend --channel conda-forge
```
